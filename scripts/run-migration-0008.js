...
const migrationPath = path.join(__dirname, '..', 'drizzle', '0008_cost_planning.sql');
...
console.log(`Running Cost Planning migration with ${statements.length} statements...`);
...
try {
    ...
    console.log('\n✅ Cost Planning migration completed successfully!');

    // Verify the new tables
    const tables = ['companies', 'cost_lines', 'cost_line_allocations', 'variations', 'invoices', 'cost_line_comments', 'project_snapshots', 'import_templates'];
