Profiler Module: 100% Market Coverage Implementation Plan
Executive Summary
This plan expands the profiler module from 6 building classes with 47 subclasses to 8 building classes with 110+ subclasses, achieving comprehensive coverage of all construction project types encountered by PM consultancies across Australia, UK, US, and New Zealand markets.

Multi-Region Support: The system will be designed with region-agnostic core classifications and region-specific overlays for building codes, approval pathways, and cost benchmarks.

Current State
Metric	Current	Target
Building Classes	6	8
Total Subclasses	47	95+
Work Scope Project Types	3 (refurb, remediation, extend)	5 (+ new, advisory)
Complexity Dimensions	~30	~50
Risk Flags	5	15+
Current Building Classes
Residential (9 subclasses) - House, Apartments, Townhouses, BTR, Student Housing, Retirement Living, Aged Care 9c, Social/Affordable
Commercial (7 subclasses) - Office, Retail Shopping, Retail Standalone, Hotel, F&B, Serviced Office
Industrial (7 subclasses) - Warehouse, Logistics, Manufacturing, Cold Storage, Data Centre, Dangerous Goods
Institution (9 subclasses) - Education (3), Healthcare (3), Government, Religious
Mixed (7 subclasses) - Various combinations
Infrastructure (8 subclasses) - Roads, Rail, Water, Energy, Marine, Airports, Telecom
Phase 1: Expand Existing Building Classes
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

1.1 Residential Additions (+4 subclasses)
...
Co-living: shared_ratio, demographics (students, professionals, mixed), operator_model
1.2 Commercial Additions (+6 subclasses)
...
1.3 Industrial Additions (+6 subclasses)
...
1.4 Institution Additions (+7 subclasses)
...
1.5 Infrastructure Additions (+9 subclasses)
...
Phase 2: Add Agricultural/Rural Building Class
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

This sector is completely missing from the current system.

2.1 New Building Class Definition
...
Phase 3: Add Defense/Secure Building Class
Priority: MEDIUM | Impact: MEDIUM | Effort: MEDIUM

Specialized sector for government and defense projects.

3.1 New Building Class Definition
...
3.2 Complexity Options (Security-Focused)
...
Phase 4: Expand Work Scope for NEW and ADVISORY Project Types
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

Currently work scope only exists for refurb, remediation, extend. This adds NEW and ADVISORY.

4.1 Work Scope for NEW Builds
...
4.2 Work Scope for ADVISORY Projects
...
Primary Files
File	Changes
profile-templates.json	Add all new subclasses, scale fields, complexity options, work scope items
profiler.ts	Update BUILDING_CLASSES array to add 'agricultural', 'defense_secure'
profile.ts	Update buildingClass enum validation
Secondary Files
File	Changes
schema.ts	Update buildingClass enum if using strict DB validation
pg-schema.ts	Update buildingClass enum for PostgreSQL
ConsultantPreview.tsx	Add discipline mappings for new subclasses
RiskFlags.tsx	Add new risk flag detection logic
ComplexityScore.tsx	Add multipliers for new complexity dimensions
ProfileSection.tsx	Add icons for new building classes
Implementation Sequence
Week 1-2: Phase 1 (Subclass Expansion)
Update profile-templates.json with all new subclasses
Add scale fields and complexity options for each
Update ConsultantPreview mappings
Test in UI
Week 3: Phase 2 (Agricultural Class)
Add Agricultural building class
Update type definitions and validation
Add UI icon support
Week 4: Phase 3 (Defense/Secure Class)
Add Defense/Secure building class
Add security-specific complexity options
Week 5: Phase 4 (Work Scope Expansion)
Add NEW project type work scope
Add ADVISORY project type work scope
Update WorkScopeSelector component
Week 6: Phase 5-6 (Complexity & Risks)
Add global complexity dimensions
Add new risk flags
Update RiskFlags component
Verification Plan
Unit Tests
...
Accuracy: Cost multipliers and benchmarks reflect Rawlinsons 2025 data
Phase 7: Expand Marine/Coastal Sector
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

Add dedicated Marine/Coastal subclass to Infrastructure or create new building class.

7.1 Marine/Coastal Subclasses
Update buildingClasses.infrastructure.subclasses with expanded marine options:
...
7.3 Complexity Options for Marine
...
Phase 8: Expand Aviation Sector
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

Break out aviation from generic infrastructure into detailed subclasses.

8.1 Aviation Subclasses
...
8.3 Complexity Options for Aviation
...
Phase 9: Expand Telecommunications Sector
Priority: HIGH | Impact: HIGH | Effort: MEDIUM

Detailed telecommunications infrastructure beyond generic "telecom" subclass.

9.1 Telecommunications Subclasses
Update buildingClasses.infrastructure.subclasses:
...
9.2 Scale Fields for Telecommunications
...
9.3 Complexity Options for Telecommunications
...
Phase 10: Multi-Region Support Architecture
Priority: HIGH | Impact: HIGH | Effort: HIGH

Design the system to support Australia, UK, US, and New Zealand markets.

10.1 Region Configuration Structure
...
10.2 Region-Specific Building Code Mappings
...
10.3 Region-Specific Approval Pathways
Update complexity options to be region-aware:
...
10.4 Region-Specific Cost Benchmarks
...
10.5 UI Changes for Multi-Region
Add region selector in project setup
Display region-specific building code labels in ContextChips
Show region-appropriate approval pathways
Display cost benchmarks in local currency
Support imperial units for US market
...
5	Phase 4	Work scope for NEW and ADVISORY
6	Phase 5-6	Global complexity dimensions + risk flags
