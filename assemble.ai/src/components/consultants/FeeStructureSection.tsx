...
import { useDisciplineFeeItems, FeeItem } from '@/lib/hooks/use-discipline-fee-items';
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
function SortableFeeItem({ item, onUpdate, onDelete }: SortableFeeItemProps) {
...
export function FeeStructureSection({ disciplineId, disciplineName }: FeeStructureSectionProps) {
  const { items, isLoading, addItem, updateItem, deleteItem, reorderItems } = useDisciplineFeeItems(disciplineId);
