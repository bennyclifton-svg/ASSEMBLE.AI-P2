    ...
    return (
        <div
            ...
            className={cn(
                ...
                // Consultants and Contractors category tiles - solid border (no bg hover)
                isConsultantsOrContractors && !isSubcategory && 'border-4 border-solid border-[#555555] bg-[#252526] hover:border-[#0e639c]',
