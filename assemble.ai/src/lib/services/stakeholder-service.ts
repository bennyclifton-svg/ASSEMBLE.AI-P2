...
export async function getStakeholders(projectId: string): Promise<StakeholderListResponse> {
  ...
  const stakeholdersWithStatus: StakeholderWithStatus[] = stakeholders.map(s => {
    const base: Stakeholder = {
      ...
      briefServicesPolished: s.briefServicesPolished ?? undefined,
      briefDeliverablesPolished: s.briefDeliverablesPolished ?? undefined,
      briefServicesViewMode: (s.briefServicesViewMode === 'long' ? 'long' : 'short'),
      briefDeliverablesViewMode: (s.briefDeliverablesViewMode === 'long' ? 'long' : 'short'),
...
export async function getStakeholderById(id: string): Promise<StakeholderWithStatus | null> {
  ...
  const base: Stakeholder = {
    ...
    briefServicesPolished: stakeholder.briefServicesPolished ?? undefined,
    briefDeliverablesPolished: stakeholder.briefDeliverablesPolished ?? undefined,
    briefServicesViewMode: (stakeholder.briefServicesViewMode === 'long' ? 'long' : 'short'),
    briefDeliverablesViewMode: (stakeholder.briefDeliverablesViewMode === 'long' ? 'long' : 'short'),
...
export async function updateStakeholder(
  ...
  await db
    ...
    .set({
      ...
      briefServicesPolished: data.briefServicesPolished,
      briefDeliverablesPolished: data.briefDeliverablesPolished,
      briefServicesViewMode: data.briefServicesViewMode,
      briefDeliverablesViewMode: data.briefDeliverablesViewMode,
