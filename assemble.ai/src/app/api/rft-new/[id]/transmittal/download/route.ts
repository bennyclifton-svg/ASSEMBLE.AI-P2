/**
 * RFT NEW Transmittal Download API Route
 * GET /api/rft-new/[id]/transmittal/download - Download transmittal documents as ZIP
 */
...
export async function GET(
    ...
    return handleApiError(async () => {
        ...
        // 1. Verify RFT NEW exists and get context info
        ...
        // 3. Create ZIP
        const zip = new JSZip();
        const folderName = 'RFT_Transmittal';
        ...
        const doc = new jsPDF();
        doc.setFontSize(18);
        doc.text('RFT Transmittal', 14, 22);
        ...
        // 6. Return Response
        const filename = `RFT_Transmittal_${new Date().toISOString().split('T')[0]}.zip`;
