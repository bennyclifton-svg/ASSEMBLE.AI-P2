...
|---|--------------|----------------------|------------------------|
| 1 | **Project Details** | Template (no AI) | RAG + AI |
| 2 | **Project Objectives** | Template (no AI) | RAG + AI |
| 3 | **Project Staging** | Template (no AI) | RAG + AI |
| 4 | **Project Risks** | Template (no AI) | RAG + AI |
| 5 | **Consultant Brief** / **Contractor Scope** | Light polish only | RAG + AI |
| 6 | **Consultant Fee** / **Contractor Price** | Template (no AI) | RAG + AI |
| 7 | **Transmittal** (if exists) | Table (no AI) | Table (no AI) |
